...
CREATE TABLE ACTUACIO_INCIDENCIA (
  ID_INCIDENCIA INT NOT NULL,
  LINIA_ACTUACIO INT NOT NULL,
  DATA_ACTUACIO DATE NOT NULL,
  ESTAT_INCIDENCIA INT NOT NULL,
  TEMPS_INVERTIT TIME,
  DESCRIPCIO_ACTUACIO TEXT NOT NULL,
  PRIMARY KEY (ID_INCIDENCIA, LINIA_ACTUACIO),
  FOREIGN KEY (ID_INCIDENCIA) REFERENCES INCIDENCIES(ID_INCIDENCIA),
  FOREIGN KEY (ESTAT_INCIDENCIA) REFERENCES ESTAT(ID_ESTAT)
);

/*Aqui fem els inserts*/
